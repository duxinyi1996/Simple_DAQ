...
class Mydata:
    ...
    def add_measurement(self,variable_name,instrument_address,instrument_name,func,f_min=0.3,f_max=8500,points=1001,power=0,bandwidth=1000,average=1):
    ...
    def data_save(self,data_dir = os.getcwd(),title='temp',file_name='name me please',my_note='', order=1):
    ...
    def read_and_save_for_VNA_involved(self,data_dir = os.getcwd(),title='temp_VNA',file_name='name me please',my_note='', order=1):
